...
const
  ...
  LIBTIEPIE_VERSION_MINOR = 7;
  LIBTIEPIE_VERSION_RELEASE = 6;
  LIBTIEPIE_VERSION_NUMBER = '0.7.6';

  LIBTIEPIE_VERSION = '0.7.6';
  LIBTIEPIE_REVISION = 12678;
  ...
  TKN_COUNT = 13; // Number of trigger kinds
  ...
  TKM_TIME = ( TKM_PULSEWIDTH or TKM_WINDOW ); // All trigger kinds that may have a time property.
  ...
  {$if defined( LINUX )}
  sLibTiePieFileNameDefault = 'libtiepie.so.0.7.6';
